...
#TODO: Need to generate a normalized and a total aggregate version of this.
...
output_export.to_csv(root + '/data/postprocessing/commercial_readiness_results.csv')
