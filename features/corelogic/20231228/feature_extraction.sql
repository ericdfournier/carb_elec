...
CREATE INDEX IF NOT EXISTS idx_corelogic_20240126_distance_mpid_idx
ON corelogic.distance_20240126 ("megaparcelid");

CREATE INDEX IF NOT EXISTS idx_corelogic_20240126_varchar_elevation_mpid_idx
ON corelogic.elevation_20240126 ("megaparcelid");

CREATE INDEX IF NOT EXISTS idx_corelogic_20240126_varchar_slope_mpid_idx
ON corelogic.slope_20240126 ("megaparcelid");

CREATE INDEX IF NOT EXISTS idx_corelogic_20240126_varchar_aspect_mpid_idx
...
SELECT  corelogic_20240126_megaparcelid,
...
GROUP BY corelogic_20240126_megaparcelid;
...
INNER JOIN corelogic.distance_20240126 AS dist
...
LEFT JOIN permits.panel_upgrades_geocoded_deduplicated_20240126 AS permits
    ON permits."corelogic_20240126_megaparcelid" = mp."megaparcelid";
